...
public class HighScore : MonoBehaviour
{
    ...
    // This function will load the high scores from a file
    public void LoadScoresFromFile()
    {
        ...
        else
        {
            ...
            return; // Stop trying to load scores if the file doesn't exist
        }

        // Makes new array of default values. This ensures that
        ...
        // A counter to make sure we don't go past the end of our scores array
        int scoreCount = 0;
        ...
        while (fileReader.Peek() != -1 && scoreCount < scores.Length)
        {
            ...
            else
            {
                ...
                // a default value (0 in this case).
    ...
    // This function will save the high scores to a file
    ...
    // This function will add a new score to the list
    public void AddScore(int newScore)
    {
        ...
        if (desiredIndex == -1)
        {
            ...
            return; // Stop here if the score isn't high enough
        }
